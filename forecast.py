...
url1 = 'https://raw.githubusercontent.com/RAJATMOUNDEKAR/streamlit_app/refs/heads/main/Transactional_data_retail_01.csv'
url2 = 'https://raw.githubusercontent.com/RAJATMOUNDEKAR/streamlit_app/refs/heads/main/Transactional_data_retail_02.csv'

# Load the data from GitHub
transactional_data_1 = pd.read_csv(url1)
transactional_data_2 = pd.read_csv(url2)
...
# ARIMA Model for the selected product
...
# Calculate errors
train_forecast = arima_fit.predict(start=train_data.index[0], end=train_data.index[-1])
test_forecast = forecast_arima[:len(test_data)]
